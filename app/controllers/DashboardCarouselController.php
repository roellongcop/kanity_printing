...
/**
 * DashboardCarouselController implements the CRUD actions for DashboardCarousel model.
 */
class DashboardCarouselController extends Controller
{
    ...
    /**
     * Lists all DashboardCarousel models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new DashboardCarouselSearch();
    ...
    /**
     * Displays a single DashboardCarousel model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Creates a new DashboardCarousel model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new DashboardCarousel();
    ...
    /**
     * Updates an existing DashboardCarousel model.
    ...
    /**
     * Deletes an existing DashboardCarousel model.
    ...
    /**
     * Finds the DashboardCarousel model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return DashboardCarousel the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
