...
/**
 * TradeReferenceSearch represents the model behind the search form of `app\models\TradeReference`.
 */
class TradeReferenceSearch extends TradeReference
{
    public $keywords;
    public $date_range;
    public $pagination;
