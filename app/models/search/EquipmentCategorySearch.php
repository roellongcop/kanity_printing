...
/**
 * EquipmentCategorySearch represents the model behind the search form of `app\models\EquipmentCategory`.
 */
class EquipmentCategorySearch extends EquipmentCategory
{
    public $keywords;
    public $date_range;
    public $pagination;
