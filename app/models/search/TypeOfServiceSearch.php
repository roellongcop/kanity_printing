...
/**
 * TypeOfServiceSearch represents the model behind the search form of `app\models\TypeOfService`.
 */
class TypeOfServiceSearch extends TypeOfService
{
    public $keywords;
    public $date_range;
    public $pagination;
    ...
    {
        return [
            [['id', 'created_by', 'updated_by', 'status', 'payment_type_id'], 'integer'],
            [['name', 'description', 'created_at', 'updated_at'], 'safe'],
            [['keywords', 'pagination', 'date_range', 'payment_type_id'], 'safe'],
