...
/**
 * BaseStockUnitSearch represents the model behind the search form of `app\models\BaseStockUnit`.
 */
class BaseStockUnitSearch extends BaseStockUnit
{
    public $keywords;
    public $date_range;
    public $pagination;
