...
/**
 * BaseStockCategorySearch represents the model behind the search form of `app\models\BaseStockCategory`.
 */
class BaseStockCategorySearch extends BaseStockCategory
{
    public $keywords;
    public $date_range;
    public $pagination;
