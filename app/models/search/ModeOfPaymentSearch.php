...
/**
 * ModeOfPaymentSearch represents the model behind the search form of `app\models\ModeOfPayment`.
 */
class ModeOfPaymentSearch extends ModeOfPayment
{
    public $keywords;
    public $date_range;
    public $pagination;
    ...
    public function search($params)
    {
        ...
        if ($this->date_range) {
            $hours = Yii::$app->General->get_datetimezone(date("Y-m-d H:i:s"),"P");
