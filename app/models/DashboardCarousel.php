...
/**
 * This is the model class for table "{{%dashboard_carousel}}".
 *
 * @property int $id
 ...
 */
class DashboardCarousel extends \yii\db\ActiveRecord
{
    public $arrayAttr = [];
    ...
    {
        $uploadPath = Yii::$app->general->createFolder(['uploads', 'dashboard-carousel']); 
