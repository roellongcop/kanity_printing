...
/**
 * This is the model class for table "{{%type_of_service}}".
 *
 * @property int $id
...
{
    public $arrayAttr = [];
    public $relatedModels = ['Quotation'];
    public $lastUpdated;
    public $createdAt;
    public $updatedAt;
    ...
    {
        return [
            [['name', 'description', 'payment_type_id'], 'required'],
            [['description'], 'string'],
    ...
    {
        return Yii::$app->params['payment_type_id'][$this->payment_type_id];
    }
    ...
    public function getCanDelete($status = 1)
    {
        ...
        foreach ($this->relatedModels as $model) {
            ...
            $_model = $mod::find()
                ->where(['type_of_service_id' => $this->id])
