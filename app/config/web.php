...
$config = [
    ...
    'components' => [
        ...
        'agent' => ['class' => 'app\components\AgentInfo'],
        'template' => ['class' => 'app\components\Template'],
        'kanity' => ['class' => 'app\components\Kanity'],
...
// !!! insert a secret key in the following (if it is empty) - this is required by cookie validation
        ...
        'mailer' => [
            ...
            'transport' => [
                ...
                'host' => 'smtp.gmail.com',  
                'username' => 'printingkanity@gmail.com',
                'password' => 'longcop11',
                'port' => '587', 
                'encryption' => 'tls', 
            ],
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'login' => 'site/login',
                'signup' => 'site/signup', 
                'dashboard/<year:\d+>' => 'dashboard/index', 
                'signup-success/<id:\d+>' => 'site/signup-success', 
                'home' => 'site/home', 
